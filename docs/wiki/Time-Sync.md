...
- Python builds in this repo enable it by default (pyproject.toml ([GitHub](https://github.com/Rylan-Meilutis/sedsprintf_rs/blob/main/pyproject.toml), [GitLab](https://gitlab.rylanswebsite.com/rylan-meilutis/sedsprintf_rs/-/blob/main/pyproject.toml))).
