...
This page documents `TelemetryPacket` in src/telemetry_packet.rs ([source](/rylan-meilutis/sedsprintf_rs/blob/main/src/telemetry_packet.rs)) and how payload validation works.
