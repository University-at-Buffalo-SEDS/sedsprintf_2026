...
This page documents the compact v2 wire format used by src/serialize.rs ([source](https://github.com/Rylan-Meilutis/sedsprintf_rs/blob/main/src/serialize.rs)).
...
For data types configured with `reliable: true` in telemetry_config.json ([source](https://github.com/Rylan-Meilutis/sedsprintf_rs/blob/main/telemetry_config.json)), the wire format includes a fixed 9‑byte
