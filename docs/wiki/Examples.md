...
1) Build the library with build.py ([source](https://github.com/Rylan-Meilutis/sedsprintf_rs/blob/main/build.py)) or CMake.
...
1) Build Python bindings with `build.py python` or `build.py maturin-install` (build.py: [source](https://github.com/Rylan-Meilutis/sedsprintf_rs/blob/main/build.py)).
