...
This page documents `TelemetryPacket` in src/telemetry_packet.rs ([source](https://gitlab.rylanswebsite.com/rylan-meilutis/sedsprintf_rs/blob/main/src/telemetry_packet.rs) | [mirror](https://github.com/Rylan-Meilutis/sedsprintf_rs/blob/main/src/telemetry_packet.rs)) and how payload validation works.
