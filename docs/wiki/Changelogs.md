...
- Full changelog: [v3.1.0...v3.2.0](/rylan-meilutis/sedsprintf_rs/compare/v3.1.0...v3.2.0)

What's included:

- Feature: `timesync` adds `TIME_SYNC` endpoint and `TIME_SYNC_ANNOUNCE/REQUEST/RESPONSE` types (built-in like
  `TelemetryError`).
- Examples: rust-example-code/timesync_example.rs ([source](/rylan-meilutis/sedsprintf_rs/blob/main/rust-example-code/timesync_example.rs)),
...
- Full changelog: [v3.0.0...v3.1.0](/rylan-meilutis/sedsprintf_rs/compare/v3.0.0...v3.1.0)
...
- Full changelog: [v2.4.0...v3.0.0](/rylan-meilutis/sedsprintf_rs/compare/v2.4.0...v3.0.0)
...
- Full changelog: [v2.3.2...v2.4.0](/rylan-meilutis/sedsprintf_rs/compare/v2.3.2...v2.4.0)

## Version 2.3.2 highlights

- Added a new unsafe API for creating link IDs.
- Fixed existing bugs.
- Full changelog: [v2.3.1...v2.3.2](/rylan-meilutis/sedsprintf_rs/compare/v2.3.1...v2.3.2)

## Version 2.3.1 highlights

- Simplified config format is now live and in production.
- Full changelog: [v2.2.3...v2.3.0](/rylan-meilutis/sedsprintf_rs/compare/v2.2.3...v2.3.0)
...
- Full changelog: [v1.5.1...v1.5.2](/rylan-meilutis/sedsprintf_rs/compare/v1.5.1...v1.5.2)

## Version 1.5.1 highlights

- Reduced memory usage for stack-stored packet payloads and overall memory footprint.
- Full changelog: [v1.5.0...v1.5.1](/rylan-meilutis/sedsprintf_rs/compare/v1.5.0...v1.5.1)

## Version 1.5.0 highlights

- Added payload and sender string compression with configurable thresholds and compression level.
- Full changelog: [v1.4.0...v1.5.0](/rylan-meilutis/sedsprintf_rs/compare/v1.4.0...v1.5.0)
...
- Full changelog: [v1.2.0...v1.4.0](/rylan-meilutis/sedsprintf_rs/compare/v1.2.0...v1.4.0)

## Version 1.2.0 highlights

- Added relay support for transporting packets across protocols (e.g., CAN to UART).
- Full changelog: [v1.1.1...v1.2.0](/rylan-meilutis/sedsprintf_rs/compare/v1.1.1...v1.2.0)
...
- Full changelog: [v1.1.0...v1.1.1](/rylan-meilutis/sedsprintf_rs/compare/v1.1.0...v1.1.1)
